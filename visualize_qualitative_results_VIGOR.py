...
dataset_root='/home/HDD/lyf/CCVPE-main/datasets/VIGOR'
...
CVM_model.load_state_dict(torch.load(test_model_path), strict=False)
CVM_model.to(device)
CVM_model.eval()
...
plt.savefig('figures/'+area+'_'+str(idx)+'_sat_'+'.png', bbox_inches='tight', pad_inches=0)
